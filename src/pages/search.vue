        ...
        <v-row>
          ...
          >
            <v-row no-gutters @click="handleDetails(book.bookId)">
              <v-col cols="4" sm="4">
                <v-img height="132" width="96" :src="book.imgUrl"></v-img>
              </v-col>
              <v-col cols="7" sm="7">
                <v-row>
                  <a>{{ book.bookName }}</a>
                  ...
                  <v-rating
                    ...
                    size="14"
                  ></v-rating>
                  <div class="red--text ml-2" style="margin-right: 10px">
                    {{ book.bookScore }}分
                  </div>
                </v-row>
                <v-row>
                ...
                <v-row
                  style="
                    ...
                    text-align: left;
                  "
                  >{{ book.introduction | subString }}</v-row
                >
              </v-col>
            </v-row>
